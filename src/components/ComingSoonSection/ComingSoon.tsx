    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          We're cooking up something great. This feature/page is under
          construction. Stay tuned!
        </p>
        <Button
          asChild
          className="px-6 py-5 h-auto text-2xl font-semibold text-primary bg-white hover:text-white rounded-sm border-2 hover:border-none"
        >
